...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'software.context_processors.empresa_global',
                'software.context_processors.modulos_permitidos',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'facsiswave'),
        'USER': os.environ.get('DB_USER', 'root'),
        'PASSWORD': os.environ.get('DB_PASSWORD', '72655883cristian'),
