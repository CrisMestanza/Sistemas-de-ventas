...
class Venta(models.Model):
    ...
    id_tipo_igv = models.ForeignKey(TipoIgv, models.DO_NOTHING, db_column='id_tipo_igv')
    idempresa = models.ForeignKey(Empresa, models.DO_NOTHING, db_column='idempresa')
    idmodoPago = models.ForeignKey(Modopago, models.DO_NOTHING, db_column='idmodoPago')
